...
Assert-Condition ($startupDiagnostics -match 'DiagnosticRedactor\.RedactText' -and $startupDiagnostics -match 'SanitizeExceptionDetail') "Persisted bootstrap failures must use the shared diagnostics redaction policy."
