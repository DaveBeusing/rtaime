...
Assert-Condition ($foundation -match 'TrySubmit') "Output submission must remain non-blocking."
...
Assert-Condition ($contractTests -match 'requires_shared_opaque_lease') "Contracts must regress lease semantics."
