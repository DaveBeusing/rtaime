...
Assert-Condition ($viewModel -match 'CanApplyGraphicsPlacement[\s\S]+ProductionCgText\.Active') "Bitmap placement must remain disabled while governed CG anchor placement is active."
