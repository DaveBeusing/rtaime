...
Assert-Condition ($timeline -match 'Binding DisplayFrame' -and $timeline -match 'OperatorAccentBrush' -and $timeline -match '<Polygon Points="0,0 10,0 5,7"') "Timeline playhead must use the cyan 2px line and cyan head treatment."
...
Assert-Condition ($timeline -notmatch 'BLADE|CUT CLIP|CutClipCommand|BladeCommand') "Timeline must not invent Blade/Cut editing while no governed edit command exists."
