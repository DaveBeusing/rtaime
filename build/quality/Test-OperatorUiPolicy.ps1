...
Assert-Condition ($compositingWorkspaceSurface -match 'Height="390\*"' -and $compositingWorkspaceSurface -match '<RowDefinition Height="6" />' -and $compositingWorkspaceSurface -match 'SYSTEM &amp; PERFORMANCE') "Compositing right stack must retain Preview above a 6px gap and the compact System & Performance surface."
