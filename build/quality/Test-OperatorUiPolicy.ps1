...
Assert-Condition ($programOutputController -match 'EnumDisplayMonitors' -and $programOutputController -match 'GetMonitorInfoW') "AP-51 must enumerate selectable Windows displays through the native monitor API."
