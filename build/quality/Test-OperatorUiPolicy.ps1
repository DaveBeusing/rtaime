...
Assert-Condition ($virtualizingWrapPanel -match 'ResolveGenerator\(\)' -and $virtualizingWrapPanel -match 'if \(generator is null\)' -and $virtualizingWrapPanel -match 'ItemsControl\.GetItemsOwner\(this\)\?\.ItemContainerGenerator') "VirtualizingWrapPanel must tolerate the WPF items generator being unavailable during early layout."
