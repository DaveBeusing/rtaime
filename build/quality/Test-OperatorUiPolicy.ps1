...
Assert-Condition ($liveSceneCue -match 'Binding DisplayIndex' -and $liveSceneCue -match 'ProgramSource\.Remaining' -and $liveSceneCue -match 'Content="NEXT"' -and $liveSceneCue -match 'Content="LIVE"' -and $liveSceneCue -match 'RtaimeIconMoreGeometry') "LIVE scene rows must expose index, duration, NEXT/LIVE states and own overflow affordance."
